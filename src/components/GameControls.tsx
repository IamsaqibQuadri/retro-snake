...
const GameControls = ({ onDirectionChange, disabled }: GameControlsProps) => {
  ...
  const buttonClass = `w-16 h-16 border-2 border-primary bg-card text-primary rounded-lg flex items-center justify-center active:bg-primary/20 transition-colors ${
